...
echo 'alias piechain="/home/bridgechain/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "/home/bridgechain/core-bridgechain"
git clone "https://github.com/vmunich/fawefweaf_core.git" "/home/bridgechain/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/vmunich/fawefweaf_core.git'"
...
rm -rf "$HOME/.config/@piechain"
rm -rf "$HOME/.config/piechain-core"
